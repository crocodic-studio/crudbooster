...
class StatisticBuilderController extends CBController
{
	...
	{
		$rows = DB::table('cms_statistic_components')->where('id_cms_statistics',$id_cms_statistics)
	...
	{
		DB::table('cms_statistic_components')->where('componentID',Request::get('componentid'))
												->update([
													'sorting'=>Request::get('sorting'),
