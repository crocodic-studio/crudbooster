...
class CBMenusController extends CBController
{
	...
	public function cbInit()
	{
		...
		#Todo: Remove icons array.Let user opens new window with icons presentation.
	...
	public function getIndex()
	{
		...
		$menu_active = DB::table('cms_menus')->where('id_cms_privileges',$id_cms_privileges)
												->where('parent_id',0)
												->where('is_active',1)
												->orderby('sorting','asc')
												->get();
		...
		$menu_inactive = DB::table('cms_menus')->where('id_cms_privileges',$id_cms_privileges)
												->where('parent_id',0)
												->where('is_active',0)
												->orderby('sorting','asc')
												->get();
