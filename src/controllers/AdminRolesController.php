...
class AdminRolesController extends CBController
{
    public function cbInit()
    {
        ...
        $this->alert[] = [
            'message' => "You can use the helper <code>cb()->getMyPrivilegeId()</code> to get current user login privilege id, or <code>cb()->getMyPrivilegeName()</code> to get current user login privilege name",
            'type' => 'info',
        ];
    }
    ...
    public function getEdit($id)
    {
        ...
        if (! cb()->isRead() && $this->global_privilege == false) {
    ...
    public function postEditSave($id)
    {
        ...
        cb()->redirect(cb()->mainpath(), trans("crudbooster.alert_update_data_success", [
            'module' => "Privilege",
            'title' => $row->name,
        ]), 'success');
    }
