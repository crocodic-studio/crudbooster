...
class AdminNotificationController extends CBController
{
    public function cbInit()
    {
        ...
        $read_notification_url = url(config('crudbooster.ADMIN_PATH')).'/notification/read';
    ...
    {
        $query->where('id_cms_users', cb()->myId());
    }

    public function getList()
    {

        $rows = DB::table('cms_notifications')->where('id_cms_users', 0)->orWhere('id_cms_users', cb()->myId())->orderby('id', 'desc')->where('is_read', 0)->take(25);
