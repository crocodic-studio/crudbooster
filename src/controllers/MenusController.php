...
use CRUDBooster;
	...
	class MenusController extends CBController {
	    ...
	    public function __construct() {
			...
			$this->form[] = array("label"=>"Type","name"=>"type","type"=>"radio","required"=>TRUE,'dataenum'=>['URL External','Controller & Method','Route','Admin Path'],'value'=>'URL External');
			$this->form[] = array("label"=>"Value","name"=>"path","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255",'help'=>'If you select type controller, you can fill this field with controller name, you may include the method also','placeholder'=>'NameController or NameController@methodName');
