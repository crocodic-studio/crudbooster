	...
	class AdminMenusController extends CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = array(
				...
				"name"=>"path",
				"type"=>"text",
				'help'=>'If you select type controller, you can fill this field with controller name, you may include the method also','placeholder'=>'NameController or NameController@methodName',"style"=>"display:none");
