...
class AdminMenusController extends CBController
{
    ...
    public function getIndex()
    {
        ...
        $id_cms_privileges = Request::get('id_cms_privileges');
        $id_cms_privileges = ($id_cms_privileges) ?: cb()->myPrivilegeId();
    ...
    public function hook_before_add(&$postdata)
    {
        if (! $postdata['id_cms_privileges']) {
            $postdata['id_cms_privileges'] = cb()->myPrivilegeId();
        }
        ...
        if ($postdata['type'] == 'Statistic') {
            ...
            $stat = cb()->first('cms_moduls', ['id' => $postdata['module_slug']]);
