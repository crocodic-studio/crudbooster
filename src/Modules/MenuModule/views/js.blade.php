    ...
    $(function () {
        ...
        if (type_menu == 'Module') {
            ...
            $('#form-group-module_slug label').append('<span class=\"text-danger\" title=\"{!! cbTrans('this_field_is_required') !!}\">*</span>');
            ...
            $('#form-group-statistic_slug label').append('<span class=\"text-danger\" title=\"{!! cbTrans('this_field_is_required') !!}\">*</span>');
        } else {
            $('#module_slug').prop('required', false);
        ...
        $('input[name=type]').click(function () {
            ...
            if (n == 'Module') {
                ...
                $('#form-group-path label').append('<span class=\"text-danger\" title=\"{!! cbTrans('this_field_is_required') !!}\">*</span>');
