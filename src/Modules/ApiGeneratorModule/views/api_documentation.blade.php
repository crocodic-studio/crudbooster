...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li><a href="{{ CRUDBooster::mainpath('secret-key') }}"><i class='fa fa-key'></i> API Secret Key</a></li>
            ...
            @push('bottom')
                <script>
                    ...
                    function deleteApi(id) {
                        var url = "{{url(cbAdminPath().'/api-generator/delete-api')}}/" + id;
                        swal({
                            title: "Are you sure?",
                ...
                <tr class='info'>
                    ...
                    <th>API Name
                      ...
                      <a class='btn btn-xs btn-warning' target="_blank"
                         href='{{CRUDBooster::mainpath("download-postman")}}'>Export For POSTMAN <sup>Beta</sup></a>
                    </span>
                    </th>
                </tr>
                </thead>
                        ...
                        <td>
                            ...
                            <sup>
                                ...
                                &nbsp; <a title='Edit This API'
                                          href="{{url(cbAdminPath().'/api-generator/edit-api').'/'.$api->id}}"><i
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table class='table table-bordered table-hover'>
                                                ...
                                                @if($i == 0)
                                                    <tr>
                                                        <td colspan='5' align="center"><i class='fa fa-search'></i>
