<?php
return [
    'email_footer'               => 'אל תשיב להודעת אימייל זו. דוא"ל זה נשלח באופן אוטומטי על ידי המערכת שלנו',
    'login_message'              => 'אנא התחבר על מנת להתחיל את הסשן',
    'text_forgot_password'       => 'שכחת את הססמא?',
    'page_title_login'           => 'פאנל התחברות',
    'page_title_forgot'          => 'שכחת ססמא',
    'forgot_message'             => 'הזן את כתובת האימייל שלך, כדי לבקש סיסמה',
    "forgot_text_try_again"      => "נסה להתחבר שום?",
    'text_no_notification'       => "יש לך 0 התראות",
    'text_view_all_notification' => 'ראה הכל',
    'label_button_profile'       => "פרופיל",
    'filter_dialog_title'        => 'מיון וסינון מתקדמים',
    'there_is_no_option'         => 'לא קיימות אפשרויות כלשהן עבור סוג קלט זה',
    'no'                         => 'לא',
