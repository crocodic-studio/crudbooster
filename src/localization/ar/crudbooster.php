...
return [
    ...
    'ListـModule'         => 'عرض التطبيقات',
    'AddـNewـStatistic'   => 'اضافة احصائيات',
    'ListـStatistic'      => 'عرض الاحصائيات',
    'AddـNewـAPI'         => 'اضافة API',
    'APIـGenerator'       => 'انشاء API',
    'StatisticـBuilder'   => 'الاحصائيات والرسوم البيانية',
    'ModuleـGenerator'    => 'تطبيقات النظام',
    'Settings'            => 'اعدادات النظام',
    'UsersـManagement'    => 'ادارة المستخدمين',
    'listـAPI'            => 'عرض API',
    'GenerateـScreetـKey' => 'انشاء مفتاح',
    'AddـNewـEmail'       => 'اضافة قالب جديد',
    'ListـEmailـTemplate' => 'عرض القوالب',
    'EmailـTemplates'     => 'قوالب البريد الإلكتروني',
    'LogـUserـAccess'     => 'سجلات النظام',
