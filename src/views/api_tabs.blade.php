...
@section('content')
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="{{ cb()->mainpath('documentation') }}"><i class='fa fa-file'></i> API Documentation</a></li>
        <li><a href="{{ cb()->mainpath('screet-key') }}"><i class='fa fa-key'></i> API Screet Key</a></li>
