            ...
            <div class="box box-primary collapsed-box">
                ...
                <form method='post' action='{{route("ApiCustomControllerPostSaveApiCustom")}}'>
                  <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                        ...
                        <div class='form-group'>
                            <label>Columns <input type='checkbox' class='uncheck_all_kolom' value='1'/></label>
                        ...
                        <div class='form-group'>
                            ...
                            <textarea name='keterangan' rows='6' class='form-control' placeholder='Optional'></textarea>
                        </div>
                    ...
                    <table class='table table-striped table-api table-bordered'>
                        ...
                        <tbody>
                              <?php 
                                  ...
                                  $date_candidate = explode(',',config('crudbooster.DATE_FIELDS_CANDIDATE'));
                                              ...
                                              case "list": 
                                                ...
                                                foreach($columns as &$col) {
                                                    $col = trim($col);
                                                      ...
                                                      foreach($double_candidate as $d) {
                                                          if($col && strpos(strtolower($col), $d)!==FALSE) {
                                                            $type = 'double';
                                                            break;
                                                          }
                                                      }
                                        ...
                                        ?>
                                          <tr>
                                              ...
                                              <td> 
                                                ...
                                                <sup>
                                                  <a title='Delete this API' onclick="if(!confirm('Are you sure want to delete ?')) return false" href="{{url(config('crudbooster.ADMIN_PATH').'/api_generator/delete-api').'/'.$ac->id}}"><i class='fa fa-trash'></i></a>
                                                  &nbsp; <a title='Edit This API' href="{{url(config('crudbooster.ADMIN_PATH').'/api_generator/edit').'/'.$ac->id}}"><i class='fa fa-pencil'></i></a> 
                                                </sup>
