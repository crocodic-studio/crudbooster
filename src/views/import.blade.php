    ...
    @if(Request::get('file') && Request::get('import'))
        ...
        <ul class='nav nav-tabs'>
            <li style="background:#eeeeee"><a style="color:#111"
                                              onclick="if(confirm('Are you sure want to leave ?')) location.href='{{ cb()->mainpath("import-data") }}'"
        ...
        <div id='box_main' class="box box-primary">
                    ...
                    <script type="text/javascript">
                        $(function () {
                            ...
                            var int_prog = setInterval(function () {
                                ...
                                $.post("{{ cb()->mainpath('do-import-chunk?file='.Request::get('file')) }}", {resume: 1}, function (resp) {
                            ...
                            $.post("{{ cb()->mainpath('do-import-chunk').'?file='.Request::get('file') }}", function (resp) {
                                if (resp.status == true) {
            ...
            <div class="box-footer" id='upload-footer' style="display:none">
                <div class='pull-right'>
                    <a href='{{ cb()->mainpath("import-data") }}' class='btn btn-default'><i class='fa fa-upload'></i> Upload Other File</a>
                    <a href='{{cb()->mainpath()}}' class='btn btn-success'>Finish</a>
                </div>
            </div><!-- /.box-footer-->
        ...
        <div id='box_main' class="box box-primary">
            ...
            <form method='post' id="form" enctype="multipart/form-data" action='{{$action}}'>
                ...
                <div class="box-footer">
                    <div class='pull-right'>
                        <a onclick="if(confirm('Are you sure want to leave ?')) location.href='{{ cb()->mainpath("import-data") }}'" href='javascript:;'
    ...
    @if(!Request::get('file'))
        ...
        <div id='box_main' class="box box-primary">
            ...
            <form method='post' id="form" enctype="multipart/form-data" action='{{$action}}'>
                ...
                <div class="box-footer">
                    <div class='pull-right'>
                        <a href='{{ cb()->mainpath() }}' class='btn btn-default'>Cancel</a>
