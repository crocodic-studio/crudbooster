...
@section("content")
    ...
    <ul class="nav nav-tabs">
        <li role="presentation"><a href="{{ cb()->adminPath('modules/step1/'.$id) }}"><i class='fa fa-info'></i> Step 1 - Module Information</a></li>
        <li role="presentation" class="active"><a href="{{ cb()->adminPath('modules/step2/'.$id) }}"><i class='fa fa-table'></i> Step 2 - Table
                Display</a></li>
        <li role="presentation"><a href="{{ cb()->adminPath('modules/step3/'.$id) }}"><i class='fa fa-plus-square-o'></i> Step 3 - Form Display</a></li>
    ...
    @push('bottom')
        <script>
            ...
            function showTableFieldLike(t) {
                ...
                $.get("{{cb()->mainpath('table-columns')}}/" + table, function (response) {
                    t.next("ul").remove();
                    var list = '';
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            ...
            <div class="box-footer">
                <div align="right">
                    <button type="button" onclick="location.href='{{cb()->mainpath('step1').'/'.$id}}'" class="btn btn-default">&laquo; Back</button>
