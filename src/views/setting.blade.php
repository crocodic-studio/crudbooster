...
@section('content')
    ...
    <div style="width:750px;margin:0 auto ">
        ...
        <p align="right"><a title='Add Field Setting' class='btn btn-sm btn-primary' href='{{ cb()->adminPath('settings/add')."?group_setting=".$page_title}}'><i
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method='post' id="form" enctype="multipart/form-data" action='{{cb()->mainpath("save-setting?group_setting=$page_title")}}'>
                    ...
                    <div class="box-body">
                        ...
                        <div class='form-group'>
                            <label class='label-setting' title="{{$s->name}}">{{$s->label}}
                                <a style="visibility:hidden" href='{{cb()->mainpath("edit/$s->id")}}' title='Edit This Meta Setting'
                                ...
                                <a style="visibility:hidden" href='javascript:;' title='Delete this Setting' class='btn btn-box-tool'
                                   onClick='swal({   title: "Are you sure?",   text: "You will not be able to recover {{$s->label}} and may be can cause some errors on your system !",   type: "warning",   showCancelButton: true,   confirmButtonColor: "#DD6B55",   confirmButtonText: "Yes, delete it!",   closeOnConfirm: false }, function(){  location.href="{{cb()->mainpath("delete/$s->id")}}" });'
                            ...
                            switch ($s->content_input_type) {
                                ...
                                case 'upload_image':
                                    if ($value) {
                                        ...
                                        echo "<div class='pull-right'><a class='btn btn-danger btn-xs' onclick='if(confirm(\"Are you sure want to delete ?\")) location.href=\"".cb()->mainpath("delete-file-setting?id=$s->id")."\"' title='Click here to delete'><i class='fa fa-trash'></i></a></div>";
                                    } else {
