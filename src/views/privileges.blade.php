...
@section('content')
    ...
    <div style="width:750px;margin:0 auto ">
        ...
        @if(cb()->getCurrentMethod() != 'getProfile')
            <p><a href='{{cb()->mainpath()}}'>{{trans("crudbooster.form_back_to_list",['module'=>cb()->getCurrentModule()->name])}}</a></p>
    @endif
    ...
    <!-- Box -->
        <div class="box box-primary">
            ...
            <form method='post' action='{{ (@$row->id)?cb()->adminPath('roles/edit-save')."/$row->id":cb()->adminPath('roles/add-save') }}'>
                ...
                <div class="box-footer" align="right">
                    <button type='button' onclick="location.href='{{cb()->mainpath()}}'"
