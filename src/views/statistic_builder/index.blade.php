    ...
    <div id='statistic-area'>
        ...
        <div class="row" style="padding-bottom:15px;">
            ...
            <div class="col-sm-2 dropdown" style="display:inline-block;width:10%;padding-left:0px;padding-right:0px;">
            ...
            <div class="col-sm-1 " style="display:inline-block;width:15%;padding-left:0px;padding-right:0px;">
