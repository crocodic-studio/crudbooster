...
@push('bottom')
    ...
    <script type="text/javascript">
        ...
        function addWidget(id_cms_statistics, area, component) {
            ...
            $.post("{{cb()->mainpath('add-component')}}", {
...
@push('head')
    ...
    <style type="text/css">
        ...
        @if(cb()->getCurrentMethod() == 'getBuilder')
                ...
                $(".connectedSortable").sortable({
                    ...
                    update: function (event, ui) {
                        if (ui.sender) {
                            ...
                            $.post("{{cb()->mainpath('update-area-component')}}", {
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('.connectedSortable').each(function () {
                ...
                $.get("{{cb()->adminpath('statistic_builder/list-component')}}/" + id_cms_statistics + "/" + areaname, function (response) {
                    if (response.components) {
                        ...
                        $.each(response.components, function (i, obj) {
                            ...
                            $.get("{{cb()->adminpath('statistic_builder/view-component')}}/" + obj.componentID, function (view) {
            ...
            $(document).on('click', '.btn-delete-component', function () {
                ...
                swal({
                    ...
                    function () {
                        ...
                        $.get("{{cb()->mainpath('delete-component')}}/" + componentID, function () {
            ...
            $(document).on('click', '.btn-edit-component', function () {
                ...
                $.get("{{cb()->mainpath('edit-component')}}/" + componentID, function (response) {
            ...
            $('#modal-statistic .btn-submit').click(function () {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: "{{cb()->mainpath('save-component')}}",
                    success: function () {
