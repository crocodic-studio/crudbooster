...
@elseif($command=='configuration')
    <form method='post'>
        ...
        <div class="form-group">
            ...
            <div class="help-block">Make sure the sql query are correct unless the widget will be broken. Mak sure give the alias name each
                column. You may use alias [SESSION_NAME] to get the session
            </div>
        </div>
