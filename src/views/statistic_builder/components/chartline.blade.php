@if($command=='layout')
    <div id='{{$componentID}}' class='border-box'>
        ...
        <div class='action pull-right'>
            <a href='javascript:void(0)' data-componentid='{{$componentID}}' data-name='Panel Area' class='btn-edit-component'><i
    ...
    <form method='post'>
        ...
        <div class="form-group">
            ...
            <div class="block-help">
                Use column name 'label' as line chart label. Use name 'value' as value of line chart. Sparate with ; each sql line. Use
                [SESSION_NAME] to use alias session.
            </div>
        </div>
