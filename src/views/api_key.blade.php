...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="{{ CRUDBooster::mainpath('screet-key') }}"><i class='fa fa-key'></i> API Secret Key</a>
        </li>
    ...
    <div class='box'>
        ...
        <div class='box-body'>
            ...
            <p><a title='Generate API Key' class='btn btn-primary' href='javascript:void(0)'
                  onclick='generate_screet_key()'><i class='fa fa-key'></i> Generate Secret Key</a></p>
            ...
            <table id='table-apikey' class='table table-striped table-bordered'>
                ...
                @if(count($apikeys)==0)
                    <tr class='no-screetkey'>
                        <td colspan='5' align="center">There is no secret key found, <a href='javascript:void(0)'
                                                                                        onclick='generate_screet_key()'>Click
