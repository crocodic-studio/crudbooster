                    ...
                    <tr>
                        ...
                        <td>
                            @if($row->status == 'active')
                                <a class='btn btn-xs btn-default' href='{{ cb()->mainpath("status-apikey?id=$row->id&status=0") }}'>Non Active</a>
                            @else
                                <a class='btn btn-xs btn-default' href='{{ cb()->mainpath("status-apikey?id=$row->id&status=1") }}'>Active</a>
                            @endif
                ...
                <script>
                    ...
                    function deleteApi(id) {
                        swal({
                            ...
                            $.get("{{cb()->mainpath('delete-api-key')}}?id=" + id, function (resp) {
                                if (resp.status == 1) {
