        ...
        <div class="navbar-custom-menu">
            ...
            <li class="dropdown notifications-menu">
                ...
                <ul id='list_notifications' class="dropdown-menu">
                  ...
                  <li class="footer"><a href="{{route('AdminNotificationsControllerGetIndex')}}">{{trans("crudbooster.text_view_all_notification")}}</a></li>
                </ul>
              </li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-{{ trans('crudbooster.left') }}">
                                <a href="{{ CB::adminPath('users/profile') }}" class="btn btn-default btn-flat"><i class='fa fa-user'></i> {{trans("crudbooster.label_button_profile")}}</a>
                            </div>
