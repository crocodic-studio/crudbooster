...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{url(config('crudbooster.ADMIN_PATH'))}}" title='{{Session::get('appname')}}' class="logo">{{cb()->getSetting('appname')}}</a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{{ cb()->myPhoto() }}" class="user-image" alt="User Image"/>
                        <!-- hidden-xs hides the username on small devices so only the image appears. -->
                        <span class="hidden-xs">{{ cb()->myName() }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- The user image in the menu -->
                        <li class="user-header">
                            <img src="{{ cb()->myPhoto() }}" class="img-circle" alt="User Image"/>
                            <p>
                                {{ cb()->myName() }}
                                <small>{{ cb()->myPrivilegeName() }}</small>
                        ...
                        <li class="user-footer">
                            <div class="pull-{{ trans('crudbooster.left') }}">
                                <a href="{{ cb()->adminPath('profile') }}" class="btn btn-default btn-flat"><i
