        ...
        <div class="navbar-custom-menu">
            ...
            <li class="dropdown notifications-menu">
                ...
                <ul id='list_notifications' class="dropdown-menu">
                  ...
                  <li class="footer"><a href="{{route('AdminNotificationsControllerGetIndex')}}">{{cbTrans("text_view_all_notification")}}</a></li>
                </ul>
              </li>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-{{ cbTrans('left') }}">
                                <a href="{{ CB::adminPath('users/profile') }}" class="btn btn-default btn-flat"><i class='fa fa-user'></i> {{cbTrans("label_button_profile")}}</a>
                            </div>
                            <div class="pull-{{ cbTrans('right') }}">
                                ...
                                <a href="javascript:void(0)" onclick="swal({   
                                    ...
                                    });" title="{{cbTrans('button_logout')}}" class="btn btn-danger btn-flat"><i class='fa fa-power-off'></i></a>
                            </div>
                        </li>
                    </ul>
                </li>
