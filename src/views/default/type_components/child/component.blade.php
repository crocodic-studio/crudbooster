                        ...
                        <div class='col-sm-10'>
                            <div class="panel panel-default">
                                <div class="panel-heading"><i
                                            class="fa fa-pencil-square-o"></i> {{cbTrans("text_form")}}</div>
                                    ...
                                    @foreach($form['columns'] as $col)
                                            ...
                                            @if($col['type']!='hidden')
                                                <label class="control-label col-sm-2">{{$col['label']}}
                                                    @if(!empty($col['required'])) <span class="text-danger"
                                                                                        title="{{cbTrans('this_field_is_required')}}">*</span> @endif
                                                </label>
                                            @endif
                                            <div class="col-sm-10">
                                                @if($col['type']=='text')
								        ...
								        <button class="btn btn-primary" id="btn-upload-{{$name_column}}"
                                                onclick="showFakeUpload{{$name_column}}()" type="button"><i
                                                    class='fa fa-search'></i> {{cbTrans('datamodal_browse_file')}}</button>
								      </span>
                                                    </div><!-- /input-group -->
                                                    ...
                                                    >
                                                        ...
                                                        if ($col['datatable']) {
                                                            ...
                                                            if (!$col['datatable_where']) {
                                                                $data = CRUDBooster::get($tableJoin, NULL,
                                                                    "$titleField ASC");
                                                            } else {
                                                                $data = CRUDBooster::get($tableJoin,
                                                                    $col['datatable_where'], "$titleField ASC");
                                                            }
                                                            foreach ($data as $d) {
                                        ...
                                        @if($col['formula'])
											...
											";
                                                ...
                                                $formula = str_replace("[" . $c['name'] . "]",
                                                    "\$('#" . $name . $c['name'] . "').val()", $formula);
                                            }
                                            ?>
                                            @push('bottom')
                                            <script type="text/javascript">
                            ...
                            <table id='table-{{$name}}' class='table table-striped table-bordered'>
                                ...
                                foreach ($form['columns'] as $i => $c) {
                                    ...
                                    if ($c['type'] == 'datamodal') {
                                        ...
                                        $data_child->join($c['datamodal_table'], $c['datamodal_table'] . '.id', '=',
                                            $c['name']);
