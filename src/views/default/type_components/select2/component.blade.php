        ...
        <select style='width:100%' class='form-control' id="{{$name}}"
            ...
            @if($form['datatable'])
                @if($form['relationship_table'])
                    ...
                    $pk = cb()->findPrimaryKey($select_table);
                    ...
                    if($form['datatable_orig'] != ''){
                        ...
                        $foreignKey2 = cb()->getForeignKey($select_table, $form['relationship_table']);
                ...
                @else
                    @if($form['datatable_ajax'] == false)
                        ...
                        $select_table_pk = cb()->findPrimaryKey($select_table);
                        ...
                        if (cb()->isColumnExists($select_table, 'deleted_at')) {
