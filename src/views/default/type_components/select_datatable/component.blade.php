	<?php $default = !empty($form['placeholder']) ? $form['placeholder'] : trans('crudbooster.text_prefix_option') ." ". $form['label'];?>
				...
				if(!$form['options']['parent_select']) {
					...
					if(@$form['options']['table']):
						...
						foreach($selects_data as $d) {			
							...
							echo "<option $select value='".$d->{$form['options']['field_value']}."'>".$label."</option>";
						}
					endif;
