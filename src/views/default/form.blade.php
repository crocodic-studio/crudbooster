...
@section('content')
    ...
    <div>
        ...
        @if(cb()->getCurrentMethod() != 'getProfile' && $button_cancel)
            @if(g('return_url'))
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding:20px 0px 0px 0px">
                <?php
                $action = (@$row) ? cb()->mainpath("edit-save/$row->id") : cb()->mainpath("add-save");
                ...
                <form class='form-horizontal' method='post' id="form" enctype="multipart/form-data" action='{{$action}}'>
                    ...
                    <div class="box-footer" style="background: #F5F5F5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                @if($button_cancel && cb()->getCurrentMethod() != 'getDetail')
                                    @if(g('return_url'))
                                        <a href='{{g("return_url")}}' class='btn btn-default'><i
                                                    class='fa fa-chevron-circle-left'></i> {{trans("crudbooster.button_back")}}</a>
                                    @else
                                        <a href='{{cb()->mainpath("?".http_build_query(@$_GET)) }}' class='btn btn-default'><i
                                                    class='fa fa-chevron-circle-left'></i> {{trans("crudbooster.button_back")}}</a>
                                    @endif
                                @endif
