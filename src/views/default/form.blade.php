...
@section('content')
    ...
    <div>
        ...
        @if(CRUDBooster::getCurrentMethod() != 'getProfile' && $button_cancel)
            @if(g('return_url'))
                <p><a title='Return' href='{{urldecode(g("return_url"))}}'><i class='fa fa-chevron-circle-left '></i>
                        &nbsp; {{trans("crudbooster.form_back_to_list",['module'=>g('label') ? :CRUDBooster::getCurrentModule()->name])}}</a></p>
            @else
