...
<?php
	...
	foreach($forms as $index=>$form) {
		...
		?>
		@if(file_exists(base_path('/vendor/crocodicstudio/crudbooster/src/views/default/type_components/'.$type.'/tableonly-component.blade.php')))
			@include('crudbooster::default.type_components.'.$type.'.tableonly-component')
		@elseif(file_exists(resource_path('views/vendor/crudbooster/type_components/'.$type.'/tableonly-component.blade.php')))
